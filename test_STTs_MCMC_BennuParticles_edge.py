...
if __name__ == "__main__":
    ...
    # )  # 20-sec cadence
    t_obs = JD0_seconds + np.linspace(0, 6 * 3600, num=5)
    ...
    # Define relative deviation fractions (e.g., 5% for position, 1% for velocity)
    pos_dev_frac = 0.025  # 2.5% of position
    vel_dev_frac = 0.0075  # 0.75% of velocity
